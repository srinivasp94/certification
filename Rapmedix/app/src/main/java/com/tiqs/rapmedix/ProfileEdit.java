...
import com.tiqs.rapmedix.utils.FileAsync;
...
public class ProfileEdit extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Url = getString(R.string.server)+ Constants.updateProfile;
...
//                                                    startActivity(intent);
	...
	private void uploadImage(String path) {
		...
		String m = getString(R.string.server)+Constants.imageUpload;
...
//                                    .thumbnail(0.1f)
	...
	public void onBackPressed() {
		...
		Intent startMain = new Intent(ProfileEdit.this, ProfilePage.class);
