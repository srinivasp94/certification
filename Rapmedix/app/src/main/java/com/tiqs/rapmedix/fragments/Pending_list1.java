...
public class Pending_list1 extends Fragment {
...
*/
    ...
    public static Pending_list1 newInstance(String text) {

        Pending_list1 f = new Pending_list1();
        Bundle b = new Bundle();
...
//appointment_data_model.specialization = jsonObject.getString("");
