...
public class Pending_list3 extends Fragment {
...
*/
    ...
    public static Pending_list3 newInstance(String text) {

        Pending_list3 f = new Pending_list3();
        Bundle b = new Bundle();
                    ...
                    try
                    {
                        ...
                        if (status.equals("success")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                appointment_data_model.cancel = Integer.parseInt(jsonObject.getString("status"));
