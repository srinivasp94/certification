...
public class Hospital_Tab_Fragment_service extends Fragment
{
		public static final String EXTRA_MESSAGE = "EXTRA_MESSAGE";
		public static final Hospital_Tab_Fragment_service newInstance(String message)
		{
			Hospital_Tab_Fragment_service f = new Hospital_Tab_Fragment_service();
