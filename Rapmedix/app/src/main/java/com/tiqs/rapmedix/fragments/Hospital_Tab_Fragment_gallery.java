...
public class Hospital_Tab_Fragment_gallery extends Fragment
{
		public static final String EXTRA_MESSAGE = "EXTRA_MESSAGE";
		public static final Hospital_Tab_Fragment_gallery newInstance(String message)
		{
			Hospital_Tab_Fragment_gallery f = new Hospital_Tab_Fragment_gallery();
